...
## Video Upscale Workflow (Optional Post-Processing)

> **Note**: This workflow is **optional** and occurs **after** base video generation (T2V, I2V, or R2V). See [Video Upscaling Guide](../guides/05_VIDEO_UPSCALING.md) for detailed implementation.
