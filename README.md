# 🎬 VEO Pro Max — AI Video Generator
...
**VEO Pro Max** là công cụ tạo video AI hàng loạt #1 Việt Nam, tự động hóa toàn bộ quy trình Google VEO 3.1:

- ✅ Nhập 1000 prompt → Bấm Start → Đi ngủ → Sáng dậy có 2000+ video 4K
...
- **Auto-Retry**: Video lỗi? App tự retry, bạn không cần làm gì
- **Crash Recovery**: Mất điện giữa chừng? Restart — app tự tiếp tục đúng chỗ

### 👥 Đa tài khoản — Gấp 10x năng suất
- Chạy **nhiều tài khoản Google** đồng thời trên 1 máy
- Mỗi tài khoản xử lý song song nhiều video
- Tự động phân bổ công việc — account rảnh nhận task mới
...
| **Tốc độ** | Fast (ưu tiên) — LP (hàng đợi dài hơn) |
...
VEO Pro Max được xây dựng với giao diện dark theme hiện đại:

- **8 Tab chuyên biệt** — mỗi workflow có giao diện riêng
- **Queue Monitor** — theo dõi real-time hàng đợi và tiến trình
- **Account Dashboard** — xem trạng thái session, credits, reCAPTCHA
...
1. Tải file `VEO_Pro_Max.exe` từ [Releases](../../releases)
2. Giải nén toàn bộ thư mục (giữ nguyên cấu trúc)
3. Chạy `VEO_Pro_Max.exe`
4. Nhập license key hoặc dùng thử miễn phí

---

## 📞 Liên hệ

- 📱 **Zalo**: Liên hệ trực tiếp qua số hotline trong app
- 💬 **Thanh toán**: Chuyển khoản ngân hàng, MoMo, ZaloPay
- ⚡ **Kích hoạt**: Nhận key ngay sau thanh toán — dùng ngay!
