...
- Include subject, setting, and composition details"""
    ...
    def _on_add_to_queue(self):
        ...
        if not TabT2I._suppress_concurrency_warning and self.controller and hasattr(self.controller, 'get_concurrency_warnings'):
            ...
            if warnings:
                ...
                if dont_remind.isChecked():
                    TabT2I._suppress_concurrency_warning = True
