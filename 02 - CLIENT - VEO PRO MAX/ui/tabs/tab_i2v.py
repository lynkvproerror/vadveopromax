...
the Library or from Continuation (previous video frame)."""
    ...
    def _on_add_to_queue(self):
        ...
        if not TabI2V._suppress_concurrency_warning and self.controller and hasattr(self.controller, 'get_concurrency_warnings'):
            ...
            if warnings:
                ...
                if dont_remind.isChecked():
                    TabI2V._suppress_concurrency_warning = True
