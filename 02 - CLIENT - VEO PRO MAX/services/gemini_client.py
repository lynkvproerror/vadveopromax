...
class GeminiClient:
    ...
    ENHANCE_SYSTEM = (
        ...
        "4. LANGUAGE: Vietnamese dialogue stays Vietnamese. Do NOT translate.\n"
    ...
    FIX_POLICY_SYSTEM = (
        ...
        "CAT11 AUDIO/DIALOGUE NOISE:\n"
        "  Vietnamese dialogue in prompt confuses video AI. Remove ALL quoted speech "
        "and audio notes. Replace with expression: 'talking happily, excited expression'\n"
        "CAT12 NOISY DETAILS:\n"
