#!/usr/bin/env python3
"""
Extension Obfuscation Script v2.0 — macOS Version
====================================================

Minifies and obfuscates the Chrome extension JS files
before deploying to the macOS release folder (04.2).
...
Usage:
    python obfuscate_extension.py                    # Obfuscate → folder 04.2
...
DEFAULT_OUTPUT = BASE_DIR / "04.2 - macOS final build" / "VEO_Pro_Max.app" / "Contents" / "Resources" / "extension"
...
def obfuscate_js(source: str, filename: str = "") -> str:
    ...
    header = "/* VEO Pro Max Extension - Protected */\n"
...
def main():
    ...
    print("=" * 50)
    print("  VEO Extension Obfuscator v2.0 (macOS)")
    print("=" * 50)
