#!/usr/bin/env python3
"""
VEO Pro Max — Workflow Data Encryptor (Build Tool)
===================================================
...
Usage (standalone):
    ...
    python encrypt_data.py "D:/path/to/main.dist/data"

Usage (from build_release.py):
    from encrypt_data import encrypt_directory
    encrypt_directory(Path("03 - Final App Client/main.dist/data"))
...
def encrypt_directory(target_dir: Path) -> int:
    ...
    Args:
        target_dir: Directory to process (e.g., main.dist/data/)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        ...
        print("Example: python encrypt_data.py ../03\\ -\\ Final\\ App\\ Client/main.dist/data")
        sys.exit(1)
